...
public class BusinessServiceImpl extends ServiceImpl<BusinessMapper, Business> implements BusinessService {
    ...
    @Override
    @CacheEvict(allEntries = true)
    public boolean update(Business entity, QueryWrapper query) {
        return super.update(entity, query);
    }

    @Override
    @CacheEvict(key = "#entity.id")
    public boolean updateById(Business entity, boolean ignoreNulls) {
        return super.updateById(entity, ignoreNulls);
    }

    @Override
    @CacheEvict(allEntries = true)
    public boolean updateBatch(Collection<Business> entities, int batchSize) {
    ...
    public Business getOne(QueryWrapper query) {
    ...
    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public List<Business> list(QueryWrapper query) {
    ...
    @Override
    @Deprecated
    public List<Business> listByIds(Collection<? extends Serializable> ids) {
