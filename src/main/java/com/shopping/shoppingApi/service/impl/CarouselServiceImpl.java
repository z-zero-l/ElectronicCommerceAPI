...
public class CarouselServiceImpl extends ServiceImpl<CarouselMapper, Carousel> implements CarouselService {
    ...
    @Override
    @CacheEvict(allEntries = true)
    public boolean update(Carousel entity, QueryWrapper query) {
        return super.update(entity, query);
    }

    @Override
    @CacheEvict(key = "#entity.id")
    public boolean updateById(Carousel entity, boolean ignoreNulls) {
        return super.updateById(entity, ignoreNulls);
    }

    @Override
    @CacheEvict(allEntries = true)
    public boolean updateBatch(Collection<Carousel> entities, int batchSize) {
    ...
    public Carousel getOne(QueryWrapper query) {
    ...
    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public List<Carousel> list(QueryWrapper query) {
    ...
    @Override
    @Deprecated
    public List<Carousel> listByIds(Collection<? extends Serializable> ids) {
