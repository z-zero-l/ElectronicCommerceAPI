...
public class CollectServiceImpl extends ServiceImpl<CollectMapper, Collect> implements CollectService {
    ...
    @Override
    @CacheEvict(allEntries = true)
    public boolean update(Collect entity, QueryWrapper query) {
        return super.update(entity, query);
    }

    @Override
    @CacheEvict(key = "#entity.id")
    public boolean updateById(Collect entity, boolean ignoreNulls) {
        return super.updateById(entity, ignoreNulls);
    }

    @Override
    @CacheEvict(allEntries = true)
    public boolean updateBatch(Collection<Collect> entities, int batchSize) {
    ...
    public Collect getOne(QueryWrapper query) {
    ...
    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public List<Collect> list(QueryWrapper query) {
    ...
    @Override
    @Deprecated
    public List<Collect> listByIds(Collection<? extends Serializable> ids) {
