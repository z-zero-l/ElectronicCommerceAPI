...
public class OrderItemServiceImpl extends ServiceImpl<OrderItemMapper, OrderItem> implements OrderItemService {
    ...
    @Override
    @CacheEvict(allEntries = true)
    public boolean update(OrderItem entity, QueryWrapper query) {
        return super.update(entity, query);
    }

    @Override
    @CacheEvict(key = "#entity.id")
    public boolean updateById(OrderItem entity, boolean ignoreNulls) {
        return super.updateById(entity, ignoreNulls);
    }

    @Override
    @CacheEvict(allEntries = true)
    public boolean updateBatch(Collection<OrderItem> entities, int batchSize) {
    ...
    public OrderItem getOne(QueryWrapper query) {
    ...
    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public List<OrderItem> list(QueryWrapper query) {
    ...
    @Override
    @Deprecated
    public List<OrderItem> listByIds(Collection<? extends Serializable> ids) {
